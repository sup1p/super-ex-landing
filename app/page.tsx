          ...
          <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4">
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                <Link href="https://www.instagram.com/yourmegan_ai" className="text-muted-foreground hover:text-foreground transition-colors">
                  {/* Instagram icon */}
                ...
                <Link href="https://www.linkedin.com/in/omar-sembek" className="text-muted-foreground hover:text-foreground transition-colors">
                  {/* LinkedIn icon */}
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="size-5">
